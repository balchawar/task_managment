...
<div class="col-lg-12">
			...
			<div class="callout callout-info">
				<div class="col-md-12">
					<div class="row">
						<div class="col-sm-6">
							<dl>
								<dt><b class="border-bottom border-primary">Order Name</b></dt>
								<dd><?php echo ucwords($name) ?></dd>
							</dl>	
								<dl>
									<dt><b class="border-bottom border-primary">Mode</b></dt>
									<dd><?php echo ucwords($mode) ?></dd>
								</dl>
								<dl><dt><b class="border-bottom border-primary">Supplier</b></dt>
								<dd><?php echo ucwords($supplier) ?></dd>
								</dl>
								<dl><dt><b class="border-bottom border-primary">Country</b></dt>
								<dd><?php echo ucwords($country) ?></dd>
								</dl>
								<dl><dt><b class="border-bottom border-primary">Description</b></dt>
	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>Stage List:</b></span>
					<?php if($_SESSION['login_type'] != 3): ?>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_task"><i class="fa fa-plus"></i> New Stage</button>
					</div>
				<?php endif; ?>
				</div>
...
<script>
	...
	$('.view_task').click(function(){
		uni_modal("Stage Details","view_task.php?id="+$(this).attr('data-id'),"mid-large")
	})
